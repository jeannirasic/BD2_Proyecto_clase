...
CREATE VIEW VIEW_INFORMACION_TEMPORADAS AS
	SELECT TEMPORADA.NOMBRE_TEMPORADA as 'Temporada', A1.TOTAL_TEMPORADA as 'Goles_Totales', A2.EQUIPO 'Max_Goleador', MAX(A2.GOLES) as 'Maxi', A3.EQUIPO as 'Min_Goleador', MIN(A3.GOLES) as 'Min'
    FROM(
